...
class FieldSpec extends ObjectBehavior
{
    ...
    function it_should_return_the_default_language_when_the_header_string_is_null()
    {
        $this->beConstructedWith(FieldTypeFactory::makeTypeLanguage(), null);
        $this->__toString()->shouldBeEqualTo('*;q=1');
    }
    function it_should_return_the_default_media_when_the_header_string_is_null()
    {
        $this->beConstructedWith(FieldTypeFactory::makeTypeMedia(), null);
        $this->__toString()->shouldBeEqualTo('*/*;q=1');
    }
    ...
    function it_should_return_the_default_language_when_the_header_string_is_empty()
    {
        $this->beConstructedWith(FieldTypeFactory::makeTypeLanguage(), '');
        $this->__toString()->shouldBeEqualTo('*;q=1');
    }
    function it_should_return_the_default_media_when_the_header_string_is_empty()
    {
    ...
    {
        $this->beConstructedWith(FieldTypeFactory::makeTypeCharset(), 'iso-8859-5, *, unicode-1-1;q=0.8');
        $this->shouldNotHaveAcceptAllSubTag(Argument::any());
    }
    function it_should_be_aware_of_having_the_accept_all_sub_tag_for_a_specific_language_tag()
    {
        $this->beConstructedWith(FieldTypeFactory::makeTypeLanguage(), 'da, en-gb;q=0.8, *, en;q=0.7');
        $this->shouldHaveAcceptAllSubTag('da');
    }
    function it_should_be_aware_of_having_the_accept_all_sub_tag_for_a_specific_media_tag()
    {
    ...
    function it_should_return_values_matching_a_specific_language_tag()
    {
    ...
    function it_should_sort_the_languages()
    {
