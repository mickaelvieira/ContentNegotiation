...
class CharsetSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith('charset', 'utf-8, utf-7, *;q=0.3, iso-8859-1, unicode-1-1;q=0.8');
        $this->findFirstMatchingValue(['utf-8', 'utf-7'])->shouldHaveType('ContentNegotiation\Header\Value');
    ...
    {
        $this->beConstructedWith('charset', 'utf-8, utf-7, *;q=0.3, unicode-1-1;q=0.8');
