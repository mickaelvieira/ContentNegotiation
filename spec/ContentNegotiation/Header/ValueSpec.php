...
class ValueSpec extends ObjectBehavior
{
    ...
    {
        $this->beConstructedWith('*/*;q=0.4', null, "/");
        $this->shouldHaveTag("*");
    ...
    {
        $this->beConstructedWith('audio/*;q=0.4', null, "/");
    ...
    {
        $this->beConstructedWith('application/*;q=0.4', null, "/");
        $this->shouldHaveAcceptAllSubTag();
    }
    ...
    {
        $this->beConstructedWith('application/json;q=5', null, "/");
